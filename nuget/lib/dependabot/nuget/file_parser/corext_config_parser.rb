...
# For details on corext.config files see:
# https://aka.ms/corext
module Dependabot
  module Nuget
    class FileParser
      class CorextConfigFileParser
        require "dependabot/file_parsers/base/dependency_set"

        DEPENDENCY_SELECTOR = "corext > packages > package"
        ...
        def dependency_version(dependency_node)
          # Ranges and wildcards aren't allowed in a corext.config - the
